...
Complete single-file research script with:
  ...
  - Visible deliberative safety scaffolds (NOT hidden chain-of-thought extraction)
...
Safety note:
  ...
  prompts, not attempts to extract private chain-of-thought.
...
def main() -> None:
    ...
    for seed in seeds:
        ...
        for li, language in enumerate(languages, start=1):
            ...
            print(f"Refusal starts        : {' | '.join(refusal_starts)}")
            print(f"Pieces/start          : {pieces_per_start:.3f}")
